...
data class TransferStrings(
    ...
    val cancelTransferTitle: String,
    val cancelTransferBody: String,
    val transferCanceled: String,
    val finalizingMetadata: String,
    val finalizingMetadataHint: String,
    val waitingForNetwork: String,
    val downloadRestartedRemoteChanged: String,
    val partialDownloadMissingRestarted: String,
    val rangeIgnoredRestarted: String,
...
fun stringsFor(language: AppLanguage): AppStrings = when (language) {
    AppLanguage.ZH_CN -> AppStrings(
        ...
        transfers = TransferStrings(
            ...
            resume = "继续",
            cancelTransfer = "取消传输",
            cancelTransferTitle = "取消传输？",
            cancelTransferBody = "取消会终止该传输并清理本地的断点数据，已上传的分片会被丢弃，且无法恢复。",
            transferCanceled = "传输已取消",
            finalizingMetadata = "正在写入元数据",
            finalizingMetadataHint = "OSS 传输已完成，正在向服务器登记文件信息，此阶段无法暂停。",
            waitingForNetwork = "等待网络",
            downloadRestartedRemoteChanged = "远程文件已发生变化，下载已重新开始",
            partialDownloadMissingRestarted = "本地未完成的下载已失效，下载已重新开始",
            rangeIgnoredRestarted = "服务器不支持断点续传，下载已重新开始",
    ...
    AppLanguage.EN_US -> AppStrings(
        ...
        transfers = TransferStrings(
            ...
            cancelTransferTitle = "Cancel this transfer?",
            cancelTransferBody = "Cancelling stops the transfer and deletes its local checkpoint data. Already uploaded parts are discarded and cannot be recovered.",
            transferCanceled = "Transfer canceled",
            finalizingMetadata = "Finalizing metadata",
            finalizingMetadataHint = "The OSS transfer already completed; the file is being registered on the server. This step cannot be paused.",
            waitingForNetwork = "Waiting for network",
            downloadRestartedRemoteChanged = "The remote file changed, so the download restarted",
            partialDownloadMissingRestarted = "The partial download was no longer available, so it restarted",
            rangeIgnoredRestarted = "The server ignored the resume request, so the download restarted",
